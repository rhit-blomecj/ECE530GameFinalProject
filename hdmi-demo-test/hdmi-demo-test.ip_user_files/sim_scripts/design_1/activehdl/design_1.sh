...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/ECE530/project/Zybo-Z7-20-HDMI-v2018.2-2_w_xpr/hdmi_demo_changed_for_testing/hdmi_demo_changed_for_testing.cache/compile_simlib/activehdl"
  fi
